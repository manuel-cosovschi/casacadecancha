    ...
    <div className="space-y-5">
      ...
      <form action={savePromotion} className="card p-5">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* "Envío gratis" volvió a la lista ahora que funciona de verdad.
              Antes `validateCoupon` lo aceptaba y le decía al cliente "Cupón
              de envío gratis aplicado", pero el cálculo del envío nunca miraba
              el cupón: se le prometía y se le cobraba igual. */}
