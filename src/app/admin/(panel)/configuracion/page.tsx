    ...
    <div className="space-y-5">
      ...
      <SettingsForm
        ...
        fields={[
          ...
          { key: 'fuel_price', label: 'Precio nafta ($/litro)', type: 'number', hint: 'Lo que pagás hoy en la estación. Es el único número de acá que se mueve solo: si no lo actualizás, cobrás de menos.' },
          { key: 'fuel_consumption', label: 'Consumo del auto (L/100km)', type: 'number' },
          { key: 'round_trip', label: 'Cobrar el viaje entero (ida y vuelta)', type: 'boolean', hint: 'Llevar algo a 7 km son 14 km de manejo, porque volvés. Si lo apagás cobrás solo la ida y la vuelta la ponés vos.' },
          { key: 'road_factor', label: 'Factor calle de respaldo (ej 1.3)', type: 'number', hint: 'Solo se usa si el mapa no contesta. Normalmente los km se miden sobre el recorrido real.' },
          { key: 'mdp_free_km', label: 'Radio gratis (km en auto)', type: 'number', hint: 'Kilómetros de manejo, los mismos que muestra Google Maps. Dentro de este radio el envío es gratis (Constitución / hasta Av. Libertad ≈ 4.5).' },
